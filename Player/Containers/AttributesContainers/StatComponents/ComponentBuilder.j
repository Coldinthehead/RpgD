library ComponentBuilderLib
{
    public struct ComponentBuilder
    {
        ...
        public static method buildAttackDamageComponent(integer pid)->IStatComponent
        {
        ...
        public static method buildArmourComponent(integer pid)->IStatComponent
        {
            AttributeWithAbilityComponent result = thistype.buildDefaultComponent(pid);
        ...
        public static method buildAttackSpeedComponent(integer pid)->IStatComponent
        {
            AttributeWithAbilityComponent result = thistype.buildDefaultComponent(pid);
        ...
        public static method buildStrComponent(integer pid)->IStatComponent
        {
            AttributeWithAbilityComponent result = thistype.buildDefaultComponent(pid);
        ...
        public static method buildDexComponent(integer pid)->IStatComponent
        {
            AttributeWithAbilityComponent result = thistype.buildDefaultComponent(pid);
        ...
        public static method buildIntCodes(integer pid)->IStatComponent
        {
            AttributeWithAbilityComponent result = thistype.buildDefaultComponent(pid);
